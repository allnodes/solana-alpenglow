use {
    allnodes_service_protos::{
        ...
        CAP_GET_BOOTSTRAP_INFO, CAP_HEARTBEAT, CAP_PROCESS_POH_CORE_CONFIG, CoreConfig, Flags,
        GetServiceInfoRequest, HeartbeatRequest, ProcessPohCoreConfigRequest,
        ProcessPohCoreConfigResponse, ServiceCapabilities, client::AllnodesServiceClient,
    },
